...
export default function Plan() {
  ...
  return (
    <section className="max-w-[1380px] w-full mx-auto overflow-hidden pb-0">
          ...
          {quotes.map((item, i) => (
            <div key={i} className="quote-item flex-col">
              <div>
                ...
                <div className="m-4 p-2 text-base bg-[none] text-[#0066f5] border-2 border-[#0066f5] cursor-pointer rounded-md flex justify-center items-center hover:bg-[#0066f5] hover:text-white">
