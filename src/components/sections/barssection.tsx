      ...
      <div className="max-w-[1380px] w-full mx-auto my-0 px-5 py-0 ">
        <div className="grid grid-cols-[54%_1fr] gap-16 max-[800px]:grid-cols-[1fr]">
          ...
          <div className="relative -ml-4">
            <div
              id="BArsANImaTIONconTAIner"
              className="relative h-[780px] w-[720px] max-[600px]:w-full max-[600px]:h-[500px] max-[400px]:hidden"
            >
              <svg
            ...
            <div
              className="opacity-100 left-[-28%] bottom-[32%] absolute z-20 max-[600px]:hidden "
              style={{
                visibility: "inherit",
            ...
            <div
              className="opacity-100 left-[1%] bottom-[56%] absolute z-20 max-[600px]:hidden"
              style={{
                visibility: "inherit",
                transform: "translate(0px, 0px)",
              }}
            ...
            <div
              className="opacity-100 right-1/4 top-[5%] absolute z-20 max-[600px]:hidden"
              style={{
                visibility: "inherit",
                transform: "translate(0px, 0px)",
              }}
